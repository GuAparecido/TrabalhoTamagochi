...
imageUrls.push({
  skinId: 2,
  urlImage: require('../assets/images/imageTeams/bahia.png'),
  urlTama: require('../assets/images/ImagesTama/bahia.png')
});

imageUrls.push({
  skinId: 3,
  urlImage: require('../assets/images/imageTeams/botafogo.png'),
  urlTama: require('../assets/images/ImagesTama/botafogo.png')
});

imageUrls.push({
  skinId: 4,
  urlImage: require('../assets/images/imageTeams/corinthians.png'),
  urlTama: require('../assets/images/ImagesTama/corinthians.png')
});

imageUrls.push({
  skinId: 5,
  urlImage: require('../assets/images/imageTeams/coritiba.png'),
  urlTama: require('../assets/images/ImagesTama/coritiba.png')
});

imageUrls.push({
  skinId: 6,
  urlImage: require('../assets/images/imageTeams/cruzeiro.png'),
  urlTama: require('../assets/images/ImagesTama/cruzeiro.png')
});

imageUrls.push({
  skinId: 7,
  urlImage: require('../assets/images/imageTeams/cuiaba.png'),
  urlTama: require('../assets/images/ImagesTama/cuiaba.png')
});

imageUrls.push({
  skinId: 8,
  urlImage: require('../assets/images/imageTeams/flamengo.png'),
